...
export  function TableSale() {
    ...
    const filteredItems = React.useMemo(() => {
      ...
      if (hasSearchFilter) {
        ...
        sales.saleFinalPrice.toLowerCase().includes(filterValue.toLowerCase()) ||
      ...
      <TableBody emptyContent={"No hay ventas registradas"}>
            {items.map((item) => (
                <TableRow key={item.idSale}>
                    ...
                    <TableCell>
                        {typeof item.saleFinalPrice === "number" ? item.purchaseFinalPrice.toLocaleString("es-ES", { style: "currency", currency: "COP" }) : "No válido"}
                    </TableCell> 
