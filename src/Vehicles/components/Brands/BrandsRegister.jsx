...
export  function BrandsRegister() {
  ...
  return (
    <div className=' flex'>
        <Button title='Agregar registro' onPress={onOpen} variant='solid' color='primary' endContent={<AiOutlinePlusCircle className=' text-white text-2xl font-bold'/>}>Agregar</Button>
