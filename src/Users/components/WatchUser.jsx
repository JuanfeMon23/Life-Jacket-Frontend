          ...
          {(onClose) => (
            <>
              <ModalHeader className="  justify-center font-bold text-2xl ">Información del usuario</ModalHeader>
                ...
                <div className="m-5 md:m-2 flex justify-around">
                    <div className=" flex flex-col">
                      <p className="text-xs md:text-sm font-bold">Tipo de documento</p> 
                      <div className=" items-end md:border-2 md:border-indigo-500/75 rounded-lg w-[7rem] md:w-[15rem] p-1">
                  ...
                  <div className="m-5 md:m-2  flex justify-around">
                    <div className=" flex flex-col">
                      ...
                      <div className=" md:border-2 md:border-indigo-500/75 rounded-lg w-[7rem] md:w-[15rem] p-1 ">
                  ...
                  <div className="m-5 flex md:m-2  justify-around">
                    <div className=" flex flex-col">
